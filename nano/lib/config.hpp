...
public:
	...
	publish_thresholds (is_live_network () ? publish_full : is_beta_network () ? publish_beta : publish_test)
	{
		...
		default_node_port = is_live_network () ? 1999 : is_beta_network () ? 11999 : 21999;
		default_rpc_port = is_live_network () ? 2999 : is_beta_network () ? 12999 : 22999;
		default_ipc_port = is_live_network () ? 3999 : is_beta_network () ? 13999 : 23999;
		default_websocket_port = is_live_network () ? 4999 : is_beta_network () ? 14999 : 24999;
